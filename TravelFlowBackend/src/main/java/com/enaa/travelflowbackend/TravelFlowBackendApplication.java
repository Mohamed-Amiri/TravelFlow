    ...
    CommandLineRunner seedTrips(TripRepository tripRepository) {
        return args -> {
            if (tripRepository.count() == 0) {
                tripRepository.save(new Trip(null, "Marrakech", "2025-11-10", 1999));
                tripRepository.save(new Trip(null, "Chefchaouen", "2025-12-05", 1499));
                tripRepository.save(new Trip(null, "Merzouga", "2026-01-20", 2299));
            }
        };
    }
